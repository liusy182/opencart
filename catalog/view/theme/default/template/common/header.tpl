...
<div id="header">
  <div class="div1">
    ...
    <div class="div3">
        <a href="<?php echo $userstats; ?>">Statistics</a>
		<a href="<?php echo $rss; ?>">RSS Feed</a>
		<a href="<?php echo $special; ?>" style="background-image: url('catalog/view/theme/default/image/special.png');"><?php echo $text_special; ?></a>
		<a href="<?php echo $contact; ?>" style="background-image: url('catalog/view/theme/default/image/contact.png');"><?php echo $text_contact; ?></a>
		<a href="<?php echo $sitemap; ?>" style="background-image: url('catalog/view/theme/default/image/sitemap.png');"><?php echo $text_sitemap; ?></a>.
	</div>
